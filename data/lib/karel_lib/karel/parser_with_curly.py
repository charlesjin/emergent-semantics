...
class KarelWithCurlyParser(Parser):
    ...
    def p_prog(self, p):
        """prog : DEF RUN LPAREN RPAREN LBRACE stmt_stmt RBRACE"""
        stmt = p[6]
        p[0] = lambda: stmt()
    ...
    def p_stmt_stmt(self, p):
        """stmt_stmt : stmt
        | stmt_stmt SEMI stmt"""
        stmt1, stmt2 = p[1], p[3] if len(p) > 2 else None
    ...
    def p_if(self, p):
        """if : IF LPAREN cond RPAREN LBRACE stmt_stmt RBRACE"""
        cond, stmt = p[3], p[6]
    ...
    def p_ifelse(self, p):
        """ifelse : IFELSE LPAREN cond RPAREN LBRACE stmt_stmt RBRACE ELSE LBRACE stmt_stmt RBRACE"""
    ...
    def p_while(self, p):
        """while : WHILE LPAREN cond RPAREN LBRACE stmt_stmt RBRACE"""
        cond, stmt = p[3], p[6]
    ...
    def p_repeat(self, p):
        """repeat : REPEAT LPAREN cste RPAREN LBRACE stmt_stmt RBRACE"""
        cste, stmt = p[3], p[6]
